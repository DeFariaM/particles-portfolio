...
const ProjectsBtn = () => {
  return (
    <div className="mx-auto max-w-fit xl:mx-0">
      <Link
        href={"/work"}
        className="relative flex h-[185px] w-[185px] items-center justify-center bg-circleStar bg-cover bg-center bg-no-repeat"
      >
        <Image
